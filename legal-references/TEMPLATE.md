...
- [ ] **No fact stated twice**: each fact (BOL limitation, constitutional provision, national law, Shari'ah principle, BAA function) appears in ONE theme only. Later themes cross-reference earlier ones using "As established in **Theme X**..."
...
- [ ] **A (BOL)** does NOT describe implementation details (that's E)
- [ ] **B (Shari'ah)** does NOT list national laws (that's D) — only Shari'ah-specific sources
- [ ] **C (Constitutional)** does NOT describe how BARMM implements (that's E) or how far it can diverge (that's F)
- [ ] **D (National Law)** does NOT describe what national agencies DO operationally (that's E.2) — only lists what laws/institutions exist
- [ ] **E (Implementation)** does NOT restate BOL provisions (that's A) or constitutional provisions (that's C)
- [ ] **F (Divergence)** does NOT restate BOL limitations (already in A) or constitutional floor (already in C) — synthesizes and references them
...
- [ ] **I (Power-Specific)** does NOT re-explain Shari'ah models (already in B) — references B for Shari'ah detail
...
A granular Q&A analysis in the style of Philippine bar review materials (Bernas, Golden Notes). Answers stay as close as possible to the language of the law. All verbatim statutory text in ***bold italic***. Key terms in **bold**. Themes follow the legal hierarchy: BOL → Constitution → National Law → Implementation → Divergence → Gaps → Development.
...
[NOTE: Do NOT repeat BOL consistency requirements or limitations already stated in Theme A. Do NOT restate the constitutional floor already established in Theme C. Reference those themes instead.]

**Q. To what extent can the BARMM diverge from national law and policy in this area?**
A. [The critical analytical question. Synthesize from A (BOL limitations), C (constitutional floor), and D (national framework) to determine: what can BARMM do differently, and where are the limits? Three scenarios: BOL requires consistency → must conform; BOL is silent → constitutional floor applies; BOL expressly mandates different legislation → strongest basis for divergence.]
...
[NOTE: Do NOT repeat the unfulfilled BOL mandates already listed in Theme A. Do NOT repeat the recommended legislation already listed in the Legislative Gaps table at the bottom. Focus on jurisdictional analysis and pending bills.]
...
- **BOL limitations/conditions** → stated ONLY in Theme A. Themes F and G reference A, not restate.
- **Constitutional floor** (equal protection, due process, Art. XII provisions) → stated ONLY in Theme C. Theme F references C.
- **Unfulfilled BOL mandates** ("Parliament shall enact...") → stated ONLY in Theme A. Theme G references A.
- **Recommended legislation** → stated ONLY in the Legislative Gaps table at the bottom. Theme G analyzes jurisdictional overlaps and pending PBs, not the legislation itself.
- **National institutions** → listed in Theme D (what they are). Theme E.2 describes what they DO operationally (not what they are again).
- **Shari'ah-specific models/structures** → detailed in Theme B. Theme I references B for Shari'ah questions, doesn't re-explain the models.
- **Lead ministry BAA 13 mandate** → detailed in Theme E.1. Theme A names the ministry briefly, E.1 does the full enumeration.
- Cross-reference format: "As established in **Theme C**, the constitutional floor is Art. XII, Sec. 15..."
