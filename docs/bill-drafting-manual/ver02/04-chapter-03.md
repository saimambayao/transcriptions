...
- Cite your authority. If the Bangsamoro Organic Law mandates the legislation, say so and give the specific provision. For instance, if you are drafting a Revenue Code, note that Section 4(a), Article XVI of Republic Act No. 11054 lists it as a priority legislation for the transition period.
...
The caption is the header block at the top of every bill. It identifies the filing legislature, the session, and the bill's number within the parliamentary filing system. Here is what it looks like in practice:
...
**The session designation matters.** The BTA Parliament operated under numbered regular sessions. A future elected Parliament will likely follow a similar convention. Use the correct session designation.

**The header format may evolve.** The BTA caption includes "Bangsamoro Transition Authority Parliament" because the BTA is the interim body. When an elected Parliament sits, this line will change to reflect the new institutional name. Your bill should use whatever designation is current. The key elements — Republic of the Philippines, Bangsamoro Autonomous Region in Muslim Mindanao, and the parliamentary body — will remain.

**The "Begun and held in" line.** Enacted BAAs include a line such as: "Begun and held in Cotabato City, on Friday, the 29th day of March, 2019." This identifies the inception date of the BTA Parliament. For bills enacted during later sessions, the same inception date may appear — it marks when the Parliament was first constituted, not when the particular session began. Follow the convention used in the most recent enacted BAA when drafting this line.

**The date format.** BAAs that were passed during or after the Dual Calendar Act (BAA No. 20) include both Hijri and Gregorian dates. BAA No. 36, for instance, records its passage date as "Shawwal 26, 1444/May 17, 2023." If the dual calendar is in force at the time of your bill's enactment, both dates should appear in the approval block.
...
Section 25(a), Article VII of the Bangsamoro Organic Law states: "Every bill passed by the Parliament shall embrace only one subject which shall be expressed in the title thereof." This mirrors Article VI, Section 26(1) of the 1987 Philippine Constitution. The rule is not optional. A law whose title fails to cover its contents — or whose contents go beyond the scope indicated by its title — is vulnerable to constitutional challenge.
...
- **Keep it to one sentence.** Long titles can get long — that is fine. BAA No. 39, the Bangsamoro Holidays Act, has a long title that names the specific law being repealed. BAA No. 50, creating the Bangsamoro Kulliyyah for Islamic Studies, names the old law being repealed (MMAA No. 164). These are detailed but still one sentence.
...
The standard enacting clause for the Bangsamoro Parliament is:

> *Be it enacted by the Bangsamoro Parliament:*

During the BTA period, the enacting clause includes the transition authority designation:

> *Be it enacted by the Bangsamoro Transition Authority Parliament in session assembled:*

Some early BAAs used slightly different formulations (e.g., "Be it enacted by the Bangsamoro Transition Authority in Parliament assembled"). The differences are minor, but consistency is worth pursuing. Use the formulation above that matches the current parliamentary period you are drafting for. When the first elected Parliament convenes, the standard form — "Be it enacted by the Bangsamoro Parliament:" — applies.

**The enacting clause is not optional.** Without it, the text is not properly enacted legislation. It is the legal trigger that transforms a bill from a proposal into a command of the sovereign legislature. In Philippine jurisprudence, the enacting clause is considered one of the essential parts of a valid statute. A document without an enacting clause — no matter how detailed its provisions — is not a law.
...
- **Be specific.** The short title should be descriptive enough to identify the law. "Bangsamoro Act of 2024" is useless as a citation. "Bangsamoro Science High School System Act of 2023" (BAA No. 40) is precise.
...
Here is an example from BAA No. 36, the Revolving Fund Act:
...
And from BAA No. 39, the Holidays Act:
...
**Root it in the BOL.** Where the Bangsamoro Organic Law states a principle or policy relevant to your bill, cite it. BAA No. 25 (upgrading a hospital) directly invokes "Section 22, Article IX of Republic Act No. 11054" and its health service mandate. This is not mere formality — it connects your bill to the constitutional authority of the Bangsamoro Government and strengthens it against challenge.
...
**Consider using a lettered list for multiple policies.** BAA No. 13 (Administrative Code) and BAA No. 35 (Electoral Code) both use lettered paragraphs to state multiple principles in their declarations. BAA No. 35 sets out five distinct principles, each in its own paragraph. This is cleaner than cramming multiple ideas into a single block of prose.
...
Look at how BAA No. 5, the Attorney-General's Office Act, handles definitions:
...
And BAA No. 35, the Electoral Code, defines 23 terms, from "Automated Election System" to "Youth Sector." These definitions are essential because electoral law is technically dense and many terms have specific legal meanings that differ from their colloquial use.
...
**Be precise about scope.** If "youth" means ages 15 to 40 in your bill (as in BAA No. 10), say so explicitly. If a term includes something that a reader might not expect — for example, if "employee" includes contractual workers — state the inclusion. If it excludes something, state the exclusion.
...
BAA No. 39, the Holidays Act, provides a good example:
...
Similarly, BAA No. 9, the Recruitment Agency Regulation Act, specifies that it covers "all local and foreign recruitment and employment agencies operating and/or recruiting within the Bangsamoro Autonomous Region."

When drafting a scope clause:

- **Be explicit about inclusions.** "All ministries, agencies, offices, commissions, boards, committees, institutes, corporations whether performing governmental or proprietary function" — BAA No. 20 leaves nothing to guesswork.
...
**Simple bills** may need no formal grouping at all. BAA No. 1, adopting the Bangsamoro flag, has five sections in a flat sequence: adoption, declaration of policy, design specifications, display rules, and effectivity. No articles, no chapters, no titles. The subject is narrow enough that a linear arrangement works.

**Medium-complexity bills** group related provisions under articles. BAA No. 5, the Attorney-General's Office Act, uses four articles:
- Article I: Preliminary Provisions
- Article II: Establishment and Functions
- Article III: Legal Liaison Network
- Article IV: Miscellaneous Provisions

**Codes and comprehensive laws** use a hierarchical structure with books, titles, chapters, articles, and sections. BAA No. 13, the Administrative Code, is organized by books:
...
**Subdivisions within a section** follow this hierarchy:

1. **Subsections** — numbered in parenthetical numerals: (1), (2), (3)
2. **Paragraphs** — lettered in lowercase: (a), (b), (c)
3. **Subparagraphs** — numbered with roman numerals or sub-letters: (i), (ii), (iii)

In practice, BAAs are not perfectly consistent on this hierarchy. Some use lettered paragraphs as the first level of subdivision — (a), (b), (c) — and numbered items beneath them. Others lead with numbered subsections. The key is internal consistency: pick one approach and maintain it throughout the bill.

**Formatting conventions:**

- Section headers are bolded and italicized: **SEC. 5.** *Short Title.*
- The section number uses the abbreviated form "SEC." after the first section, which is spelled out in full: "SECTION 1" or "Section 1."
- The section heading is followed by a period or dash, then the text begins on the same line.
...
> "...pursuant to Section 8, Article XVI of Republic Act No. 11054."
...
### 3.6.4 Tips for Substantive Provisions
...
**Use the active voice and the mandatory "shall."** In legislative drafting, "shall" means "must." It imposes a duty or establishes a requirement. "May" grants discretion. Do not confuse them. "The Commission shall submit a quarterly report" is a mandatory duty. "The Commission may establish sub-offices" is discretionary authority.
...
**Handle provisos correctly.** The proviso — a clause beginning with "Provided, That" — is a traditional Philippine legislative device used to introduce exceptions, conditions, or qualifications to a general rule. It appears throughout the BOL and in most BAAs. When using provisos:
...
BAA No. 20, the Dual Calendar Act, designates the implementing office clearly:
...
BAA No. 25, upgrading a district hospital, designates the Ministry of Health:
...
BAA No. 36, the Revolving Fund Act, includes a specific reporting requirement:
...
BAA No. 36 provides for IRR with a deadline:
...
BAA No. 25 sets a sixty-day deadline:
...
BAA No. 9, the Recruitment Agency Regulation Act, includes criminal-adjacent penalties:
...
BAA No. 9 gives the Ministry of Labor and Employment the power to suspend or cancel accreditation:
...
BAA No. 5, the Attorney-General's Office Act, provides a specific initial amount and identifies the fund sources:
...
BAA No. 36, the Revolving Fund Act, appropriates a much larger amount:
...
- **Personnel.** BAA No. 50, converting the REMAcademy into the Kulliyyah for Islamic Studies, had to address what happens to existing staff.
...
The BOL itself provides an example of how transitory provisions work in the Bangsamoro context. Section 4(a), Article XVI states that "until the abovementioned laws are enacted, the Muslim Mindanao Autonomy Act No. 25, otherwise known as the 'Autonomous Region in Muslim Mindanao Local Government Code,' and subsisting laws on elections and other electoral matters shall apply in the Bangsamoro Autonomous Region." This kept the old ARMM legal framework in place until the BTA could replace it with new Bangsamoro codes — a textbook transitory provision.
...
- **Be precise about partial repeals.** If you are repealing only certain provisions of an existing law, identify those provisions specifically. "Section 47 of Bangsamoro Autonomy Act No. 03 is hereby amended to read as follows:" — as BAA No. 14 does.
...
The fifteen-day rule is the default and the safest choice. Under Philippine constitutional law, laws generally take effect fifteen days after publication, unless the law itself provides otherwise. Publication is constitutionally required for a law to be binding — an unpublished law cannot be enforced, even if the effectivity clause says "upon approval."
...
### 3.9.8 Tips for Final Provisions
