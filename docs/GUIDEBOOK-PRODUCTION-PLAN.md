...
**Purpose**: Execution plan for remaining guidebooks. Pick up in next session with "execute guidebook plan" or reference specific guidebook by number.

---

## Completed Guidebooks (4)
...
#### Guidebook 5: Speech Writing Guidebook
...
#### Guidebook 6: Policy Recommendations Guidebook
...
#### Guidebook 7: MOP Formulation Guidebook
...
#### Guidebook 8: Legal Review Guidebook
...
#### Guidebook 9: Policy Notes Guidebook
...
#### Guidebook 10: Competency Development Guidebook
...
#### Guidebook 11: Legislative Briefer (CSW) Guidebook
...
#### Guidebook 12: Resolution Drafting Guidebook
...
- Combined with existing 4 guidebooks: **12 total volumes, ~350K+ words**
...
### New Addition: Guidebook 13 — Working with the Bangsamoro Government
...
**Plan file**: `docs/PLAN-working-with-bangsamoro-government-guidebook.md` (full chapter structure + execution details)
...
**Execute**: Say **"Build guidebook 13: Working with the Bangsamoro Government"**

---

## To Execute in Next Session

Say: **"Execute guidebook plan session 1"** — builds Speech Writing + Policy Recommendations in parallel

Or pick specific: **"Build guidebook 5"** (Speech Writing), **"Build guidebook 6"** (Policy Recommendations), etc.

The plan file is at: `docs/GUIDEBOOK-PRODUCTION-PLAN.md`
