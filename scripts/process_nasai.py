...
# Source URLs for Sunan an-Nasa'i (hadith-api)
ARA_URL = "https://cdn.jsdelivr.net/gh/fawazahmed0/hadith-api@1/editions/ara-nasai.json"
ENG_URL = "https://cdn.jsdelivr.net/gh/fawazahmed0/hadith-api@1/editions/eng-nasai.json"
OUTPUT_DIR = "/Users/saidamenmambayao/apps/transcriptions/shari'ah/hadith/nasai"
...
def process_nasai():
    ...
    # Combine data using eng_hadiths as baseline for books
    ...
    for book_id, data in sorted(books_data.items(), key=lambda x: int(x[0])):
        ...
        def extract_num(n):
            ...
            # Handle cases like "1.1" or "1a" if any
        ...
        # Padding book_id with 0 for sorting
        ...
        content = [
            ...
            f"- **Source:** Sunnah.com Sunan an-Nasa'i\n",
            f"\n",
            f"---\n\n"
        ]
    ...
    print("Nasa'i Processing Complete.")
