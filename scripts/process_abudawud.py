...
# Source URLs for Sunan Abi Dawud (hadith-api)
ARA_URL = "https://cdn.jsdelivr.net/gh/fawazahmed0/hadith-api@1/editions/ara-abudawud.json"
ENG_URL = "https://cdn.jsdelivr.net/gh/fawazahmed0/hadith-api@1/editions/eng-abudawud.json"
OUTPUT_DIR = "/Users/saidamenmambayao/apps/transcriptions/shari'ah/hadith/abudawud"
...
def process_abudawud():
    ...
    for h_num, h_eng in eng_hadiths.items():
        ...
        # Skip Book 0 if it's empty or placeholder (based on Nasa'i experience)
        if book_id == "0":
            continue
    ...
    for book_id, data in sorted(books_data.items(), key=lambda x: int(x[0])):
        ...
        content = [
            ...
            f"- **Source:** Sunnah.com Sunan Abi Dawud\n",
            f"\n",
            f"---\n\n"
        ]
    ...
    print("Sunan Abi Dawud Processing Complete.")
