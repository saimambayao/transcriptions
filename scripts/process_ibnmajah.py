...
# Source URLs for Sunan Ibn Majah (hadith-api)
ARA_URL = "https://cdn.jsdelivr.net/gh/fawazahmed0/hadith-api@1/editions/ara-ibnmajah.json"
ENG_URL = "https://cdn.jsdelivr.net/gh/fawazahmed0/hadith-api@1/editions/eng-ibnmajah.json"
OUTPUT_DIR = "/Users/saidamenmambayao/apps/transcriptions/shari'ah/hadith/ibnmajah"
...
def process_ibnmajah():
    ...
    for h_num, h_eng in eng_hadiths.items():
        ...
        # Skip Book 0 if it's empty or placeholder (Intro is often 0 or 1 depending on index)
        # For Ibn Majah, let's see. Intro is usually "0" in sections.
    ...
    for book_id, data in sorted(books_data.items(), key=lambda x: int(x[0])):
        ...
        content = [
            ...
            f"- **Source:** Sunnah.com Sunan Ibn Majah\n",
            f"\n",
            f"---\n\n"
        ]
    ...
    print("Sunan Ibn Majah Processing Complete.")
