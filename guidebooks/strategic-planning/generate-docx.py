#!/usr/bin/env python3
"""
Generate Strategic Planning Guidebook DOCX from markdown chapter files.
...
OUTPUT_FILE = SCRIPT_DIR / "Strategic-Planning-Guidebook-Bangsamoro.docx"
...
def add_header_footer(doc):
    ...
    for section in doc.sections:
        ...
        run = p.add_run("MOP Formulation Guidebook — BARMM")
...
def create_title_page(doc):
    ...
    p = doc.add_paragraph()
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER
    run = p.add_run("STRATEGIC PLANNING")
    ...
    p = doc.add_paragraph()
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER
    run = p.add_run("A Practitioner's Guide to the 10-Point Strategic\nPlanning Framework for Ministries, Offices, and Agencies")
