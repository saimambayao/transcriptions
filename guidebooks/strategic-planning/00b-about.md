...
1. **Planning Officers, Budget Officers, and M&E Officers** (primary audience) — the drafters who follow the step-by-step instructions in each chapter, complete the templates, and produce the working documents that constitute the MOA Strategic Plan. If this is you, read every section of every chapter in sequence.

2. **Ministers, Executive Directors, Deputy Ministers, and Division Chiefs** (secondary audience) — decision-makers who do not draft the plan but who must understand, validate, and approve each component. Each chapter contains a **For Decision-Makers** callout that summarizes what you need to review, what questions to ask, and what your approval signifies. You can read those callouts and Chapter 12 without reading the full step-by-step instructions.
...
- **Bold text** highlights key terms, framework names, planning points, and important concepts on first use
- *Italic text* indicates document titles, template names, and technical terms on first use
- Boxed callouts marked **TIP** provide practical advice from planning practitioners
- Boxed callouts marked **CAUTION** warn about common planning mistakes and their consequences
- Boxed callouts marked **BANGSAMORO NOTE** highlight guidance specific to BARMM governance, budget cycles, and legal frameworks
- Boxed callouts marked **FOR DECISION-MAKERS** are addressed directly to Ministers, Executive Directors, and senior leadership — summarizing review responsibilities and key questions to ask
