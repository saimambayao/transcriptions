#!/usr/bin/env python3
"""
Generate Systems Change in the Bangsamoro DOCX from markdown chapter files.
...
OUTPUT_FILE = SCRIPT_DIR / "Systems-Change-in-the-Bangsamoro.docx"
...
def add_header_footer(doc):
    ...
    for section in doc.sections:
        ...
        run = p.add_run("Systems Change in the Bangsamoro — Saidamen R. Mambayao")
...
def create_title_page(doc):
    ...
    p = doc.add_paragraph()
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER
    run = p.add_run("How to Ensure that the Bangsamoro will Succeed")
