#!/usr/bin/env python3
"""
Generate a professional PDF of the Bill Drafting Guidebook (ver03)
...
OUTPUT_PDF = BASE_DIR / "Bill-Drafting-Guidebook-Bangsamoro-Parliament-v3.pdf"
...
def main():
    print("=" * 60)
    print("  Bill Drafting Guidebook v3 — PDF Generator")
    print("=" * 60)
    print()
