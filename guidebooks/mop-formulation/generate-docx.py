#!/usr/bin/env python3
"""
Generate MOP Formulation Guidebook DOCX from markdown chapter files.
...
OUTPUT_FILE = SCRIPT_DIR / "MOP-Formulation-Guidebook-BARMM.docx"
...
def create_title_page(doc):
    ...
    p = doc.add_paragraph()
    p.alignment = WD_ALIGN_PARAGRAPH.CENTER
    run = p.add_run("A Practical Guide for MOP Development Teams,\nMinistry Personnel, and Government Officers")
