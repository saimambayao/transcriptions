#!/usr/bin/env python3
"""
Generate a professional PDF of the MOP Formulation Guidebook
for BARMM Ministries, Offices, and Agencies from Markdown source files.
...
OUTPUT_PDF = BASE_DIR / "MOP-Formulation-Guidebook-BARMM.pdf"
...
def main():
    print("=" * 60)
    print("  MOP Formulation Guidebook — PDF Generator")
    print("=" * 60)
    print()
