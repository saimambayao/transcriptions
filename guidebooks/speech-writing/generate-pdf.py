#!/usr/bin/env python3
"""
Generate a professional PDF of the Speech Writing Guidebook
...
OUTPUT_PDF = BASE_DIR / "Speech-Writing-Guidebook-Bangsamoro-Parliament.pdf"
...
def build_toc_html(md_text: str) -> str:
    ...
    for line in lines:
        ...
        # H1 title - skip it (cover page handles this)
...
def post_process_html(html: str) -> str:
    ...
    # Add anchor IDs to H1 headings for TOC linking
...
def main():
    print("=" * 60)
    print("  Speech Writing Guidebook — PDF Generator")
    print("=" * 60)
    print()
