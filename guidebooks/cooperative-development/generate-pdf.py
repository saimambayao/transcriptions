#!/usr/bin/env python3
"""
Cooperative Development Guidebook — PDF Generator

Generate a professional PDF of the Cooperative Development Guidebook
for Bangsamoro Communities from Markdown source files.
...
OUTPUT_PDF = BASE_DIR / "Cooperative-Development-Guidebook-Bangsamoro.pdf"
...
def wrap_section(fname: str, html_content: str, index: int) -> str:
    ...
    if "appendices" in fname:
        return f'<div class="chapter" id="appendices">\n{html_content}\n{back_link}\n</div>\n'
...
def main():
    print("=" * 60)
    print("  Cooperative Development Guidebook — PDF Generator")
    print("=" * 60)
    print()
