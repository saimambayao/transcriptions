#!/usr/bin/env python3
"""
Generate a professional PDF of the CSW Guidebook
for the Bangsamoro Autonomous Region from Markdown source files.
...
OUTPUT_PDF = BASE_DIR / "CSW-Guidebook-Bangsamoro-Autonomous-Region.pdf"
...
def main():
    print("=" * 60)
    print("  CSW Guidebook — PDF Generator")
    print("=" * 60)
    print()
