...
description: Analyze a codebase and recommend Gemini CLI automations (hooks, subagents, skills, plugins, MCP servers). Use when user asks for automation recommendations, wants to optimize their Gemini CLI setup, mentions improving Gemini CLI workflows, asks how to first set up Gemini CLI for a project, or wants to know what Gemini CLI features they should use.
tools: Read, Glob, Grep, Bash
---

# Gemini Automation Recommender

Analyze codebase patterns to recommend tailored Gemini CLI automations across all extensibility options.
...
# Check for existing Gemini CLI config
ls -la .claude/ GEMINI.md 2>/dev/null
...
```markdown
## Gemini CLI Automation Recommendations
