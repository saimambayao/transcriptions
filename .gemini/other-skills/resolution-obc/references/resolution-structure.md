...
Bills are proposed legislation under deliberation. They become BAAs when enacted.
...
**AN ACT**
**[FULL TITLE IN UPPERCASE]**

---

**EXPLANATORY NOTE**

[Detailed explanation of the bill's purpose, background, and rationale. This section should explain:]

[1. The problem or gap the bill addresses]
[2. The policy context and legal basis]
[3. The proposed solution and its expected benefits]
[4. Any relevant statistics, studies, or precedents]
...
**SECTION 1.** _Short Title._ – This Act shall be known as the "[Short Title] Act of [Year]".

**SEC. 2.** _Declaration of Policy._ – [Policy statement].

**SEC. 3.** _Definition of Terms._ – For purposes of this Act:
...
**SEC. [N].** _Appropriations._ – [Funding provisions].

**SEC. [N+1].** _Implementing Rules and Regulations._ – [IRR provisions].

**SEC. [N+2].** _Separability Clause._ – If any provision of this Act is declared unconstitutional, the remainder shall not be affected.

**SEC. [N+3].** _Repealing Clause._ – All inconsistent laws are hereby repealed or modified accordingly.

**SEC. [N+4].** _Effectivity._ – This Act shall take effect fifteen (15) days after its publication.
...
### Bill-Specific Elements

| Element | Format | Notes |
|---------|--------|-------|
| Bill Number | **Bold** | `**Parliament Bill No. 170**` |
| "Introduced by" | Plain text | Line before author name |
| Author Name | **Bold** with title | `**HON. [NAME], MP**` |
| "Co-authored by" | Plain text | Line before co-author names |
| Explanatory Note | **Bold** header | Content in plain text paragraphs |
| Horizontal Rule | `---` | Separates explanatory note from bill text |
