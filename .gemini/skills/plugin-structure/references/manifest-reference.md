...
The manifest MUST be in the `.claude-plugin/` directory at the plugin root. Gemini CLI will not recognize plugins without this file in the correct location.
